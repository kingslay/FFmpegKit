...
#define FFMPEG_CONFIGURATION "--prefix=/Users/kintan/Documents/Github/KSPlayer/FFmpegKit/.Script/FFmpeg/macos/thin/x86_64 --disable-armv5te --disable-armv6 --disable-armv6t2 --disable-bzlib --disable-gray --disable-iconv --disable-linux-perf --disable-xlib --disable-swscale-alpha --disable-symver --disable-small --enable-cross-compile --enable-gpl --enable-libxml2 --enable-nonfree --enable-runtime-cpudetect --enable-thumb --enable-version3 --pkg-config-flags=--static --enable-static --disable-shared --enable-pic --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-avcodec --enable-avformat --enable-avutil --enable-network --enable-swresample --enable-swscale --disable-devices --disable-outdevs --disable-indevs --disable-postproc --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-muxers --enable-muxer=dash --enable-muxer=hevc --enable-muxer=mp4 --enable-muxer=m4v --enable-muxer=mov --enable-muxer=mpegts --enable-muxer='webm*' --disable-encoders --enable-protocols --disable-demuxers --enable-demuxer=aac --enable-demuxer=ac3 --enable-demuxer=aiff --enable-demuxer=amr --enable-demuxer=ape --enable-demuxer=asf --enable-demuxer=ass --enable-demuxer=av1 --enable-demuxer=avi --enable-demuxer=caf --enable-demuxer=concat --enable-demuxer=dash --enable-demuxer=data --enable-demuxer=eac3 --enable-demuxer=flac --enable-demuxer=flv --enable-demuxer=h264 --enable-demuxer=hevc --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=loas --enable-demuxer=m4v --enable-demuxer=matroska --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer='mpeg*' --enable-demuxer=ogg --enable-demuxer=rm --enable-demuxer=rtsp --enable-demuxer=rtp --enable-demuxer=srt --enable-demuxer=vc1 --enable-demuxer=wav --enable-demuxer=webm_dash_manifest --enable-bsfs --disable-decoders --enable-decoder=av1 --enable-decoder=dca --enable-decoder=flv --enable-decoder=h263 --enable-decoder=h263i --enable-decoder=h263p --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=mjpeg --enable-decoder=mjpegb --enable-decoder=mpeg1video --enable-decoder=mpeg2video --enable-decoder=mpeg4 --enable-decoder=mpegvideo --enable-decoder=rv10 --enable-decoder=rv20 --enable-decoder=rv30 --enable-decoder=rv40 --enable-decoder=tscc --enable-decoder=wmv1 --enable-decoder=wmv2 --enable-decoder=wmv3 --enable-decoder=vc1 --enable-decoder=vp6 --enable-decoder=vp6a --enable-decoder=vp6f --enable-decoder=vp7 --enable-decoder=vp8 --enable-decoder=vp9 --enable-decoder='aac*' --enable-decoder='ac3*' --enable-decoder='alac*' --enable-decoder='amr*' --enable-decoder=ape --enable-decoder=cook --enable-decoder=dca --enable-decoder=dolby_e --enable-decoder='eac3*' --enable-decoder=flac --enable-decoder='mp1*' --enable-decoder='mp2*' --enable-decoder='mp3*' --enable-decoder=opus --enable-decoder='pcm*' --enable-decoder=truehd --enable-decoder=vorbis --enable-decoder='wma*' --enable-decoder=ass --enable-decoder=ccaption --enable-decoder=dvbsub --enable-decoder=dvdsub --enable-decoder=movtext --enable-decoder=pgssub --enable-decoder=srt --enable-decoder=ssa --enable-decoder=subrip --enable-decoder=webvtt --disable-filters --enable-filter=aformat --enable-filter=amix --enable-filter=anull --enable-filter=aresample --enable-filter=areverse --enable-filter=asetrate --enable-filter=atempo --enable-filter=atrim --enable-filter=bwdif --enable-filter=delogo --enable-filter=equalizer --enable-filter=estdif --enable-filter=firequalizer --enable-filter=format --enable-filter=fps --enable-filter=hflip --enable-filter=hwdownload --enable-filter=hwmap --enable-filter=hwupload --enable-filter=idet --enable-filter=lenscorrection --enable-filter=negate --enable-filter=null --enable-filter=overlay --enable-filter=palettegen --enable-filter=paletteuse --enable-filter=pan --enable-filter=rotate --enable-filter=scale --enable-filter=setpts --enable-filter=subtitles --enable-filter=superequalizer --enable-filter=transpose --enable-filter=trim --enable-filter=vflip --enable-filter=volume --enable-filter=w3fdif --enable-filter=yadif --disable-debug --enable-stripping --enable-optimizations --arch=x86_64 --target-os=darwin --disable-neon --disable-asm --enable-videotoolbox --enable-audiotoolbox --enable-filter=yadif_videotoolbox --enable-ffplay --enable-sdl2 --enable-encoder=aac --enable-encoder=movtext --enable-encoder=mpeg4 --enable-decoder=rawvideo --enable-filter=color --enable-filter=lut --enable-filter=testsrc --disable-avdevice --enable-debug --disable-stripping --disable-optimizations --enable-openssl --enable-libsrt --enable-protocol=libsrt --enable-libdav1d --enable-decoder=libdav1d --enable-libzvbi --enable-decoder=libzvbi_teletext"
...
#define CC_IDENT "Apple clang version 15.0.0 (clang-1500.1.0.2.4)"
